...
<title>Анкета соискателя - бумажные пакеты производство, полиэтиленовые пакеты, подарочная упаковка с символикой фирмы, изготовление пакетов,  логотип, заказ</title>
			...
			<tr>
				...
				<table border="0" width=658 cellspacing="0" cellpadding="0" align=left>
					<tr>
						...
						<td width="24" align=left><img border="0" src="images/m8.gif" width="24" height="20" ></td>
...
<table border="0" width="100%" cellspacing="0" cellpadding="0" >
	<tr>
		<td valign=top width="207"><img border="0" src="images/01.gif" width="8" height="6"><img border="0" src="images/p5.gif" width="62" height="14" usemap="#m1">&nbsp;&nbsp; 
...
<?php include "news.php" ?>
		...
		<td valign=top ><br>
			<FONT style="FONT-SIZE: 19px; COLOR: #42506d">&nbsp; &nbsp; &nbsp;&nbsp; Анкета соискателя</font>
			<br><br><br>
...
?>
			...
			<br>
						Если у Вас уже есть готовое резюме, удовлетворяющее запрашиваемой информации, <br>Вы можете прислать его по e-mail <a href="mailto:matvey@start-polus.ru?subject=Анкета соискателя">
			<font color="#42506d"><span style="text-decoration: none">matvey@start-polus.ru</span></font></a>  <br>или по факсу: (495) 223-3281. <br>Контактное лицо:	Ромодановский Матвей Валентинович
