...
подарочной упаковки с символикой фирмы</title>
<meta name="Description" content="Производство полиэтиленовых пакетов, 
подарочной упаковки с символикой фирмы, изготовление бумажных пакетов, фирменных пакетов с логотипом. Изготовление пакетов любыми тиражами шелкографией, офсетом, флексопечатью">
...
<font color="#666666">бумажные пакеты - производство - пакеты полиэтиленовые - фирменные пакеты - печать - пакеты логотип - шелкография - изготовление</font>
&nbsp;</span>
			...
			<tr>
				...
				<table align="left" border="0" cellpadding="0" cellspacing="0" width="658">
					<tbody><tr>
						...
						<td width="24"><img src="images/m5.gif" border="0" height="20" width="24"></td>
						<td align="center" bgcolor="#ffffff" width="56"><font color="#333399"><b>Каталог</b></font></td>
						<td align="center" width="24"><b><img src="images/m2.gif" border="0" height="20" width="24"></b></td>
						<td align="center" bgcolor="#041865" width="55"><a href="about.php"><span class="ss">О
                          фирме</span></a></td>
...
<div class="text"><style> div.text {line-height: 150%;}</style><br><font style="font-size: 19px; color: rgb(66, 80, 109);">Каталог
            продукции</font><br><br>
			
          <font style="font-size: 19px; color: rgb(51, 51, 153);"><a href="index.html">Бумажные
          пакеты:</a></font><br>
          Наша компания производит различные типы бумажных пакетов: <br><br>
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font style="font-size: 16px; color: rgb(51, 51, 153);"><a href="bumglos.php">Бумажные пакеты c ламинацией</a><br></font>
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="bumglos.php">Бумажные пакеты с глянцевой ламинацией</a>. Пакеты получаются яркими, а благодаря глянцевой ламинации долговечными.<br>
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="bumglos.php#bummat">Бумажные пакеты с матовой ламинацией</a>. Такие пакеты стоят немного дороже, но благодаря матовой ламинации выглядят очень стильно.<br><br>
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font style="font-size: 16px; color: rgb(51, 51, 153);"><a href="bumbezlam.php">Бумажные пакеты без ламинации</a></font><br>
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="bumbezlam.php">Бумажные пакеты из крафт-бумаги</a> получаются очень качественными, при этом их производство дешевле, что позволяет клиентам сэкономить значительное количество средств.<br>
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="bumbezlam.php#des">Бумажные пакеты из дизайнерской бумаги</a> помогут воплотить в жизнь любую вашу дизайнерскую идею.<br>
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="bumbezlam.php#len">Бумажные пакеты из картона</a>. Оптимальны при изготовлении тиражом от 1000 экземпляров.<br>
	  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="bumefalin.php">Бумажные пакеты из эфалина</a>.Переплетные материалы, идеальны для изготовления пакетов ограниченным тиражом.<br><br>
           <font style="font-size: 19px; color: rgb(51, 51, 153);"><a href="bumbox.php">Коробки:</a></font><br>
